  ...
  return (
    <section>
      ...
      <div
        ...
        tabIndex="-1"
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full mt-5 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full"
        aria-modal="true"
        role="dialog"
      >
        <div className="relative w-full h-full max-w-md p-4 overflow-y-auto md:h-auto">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="px-6 py-6 lg:px-8">
              <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                <i className="mr-2 bi bi-credit-card"></i>CARD PAYMENT
              </h3>
              <form onSubmit={handleOrderSubmit} className="space-y-6">
                ...
                <p className="mb-4 text-2xl font-semibold text-center text-lime-500">
                  ${total}
                </p>
                <button
                  type="submit"
